...
public class AutomationScripts extends ReusableMethods{
	...
	public static void TestScript_1() throws Exception {
		
		String propertyPath="./src/test/resources/DataFiles/TestScript1.properties";
		Properties pro=loadPropertyFile(propertyPath);
		
		String objectRepoPath="./src/test/resources/ObjectRepository/TestScript1Objects.properties";
	...
	public static void TestScript_3() throws IOException{
		String propertyPath="./src/test/resources/DataFiles/TestScript3.properties";
		Properties pro=loadPropertyFile(propertyPath);
	...
	public static void TestScript_9() throws Exception {
		TestScript_1();
...
//		System.out.println("files clicked");
	...
	public static void TestScript_10() throws Exception {
		TestScript_1();
	...
	public static void TestScript_11() throws Exception {
		TestScript_1();
	...
	public static void TetScript_12() throws Exception {
		TestScript_1();
